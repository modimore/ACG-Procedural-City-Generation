  ...
  for ( k = 0; k < length; k++ ) {
	for ( i = 0; i < width; i++ ) {
	  ...
	  lot_tri_verts.push_back(
	    VBOPosNormalColor(pos,y_bar,getLotColor(i,k)));
	  lot_tri_verts.push_back(
	    VBOPosNormalColor(pos+glm::vec3(0.0,0.0,1.0),y_bar,getLotColor(i,k)));
	  lot_tri_verts.push_back(
	    VBOPosNormalColor(pos+glm::vec3(1.0,0.0,1.0),y_bar,getLotColor(i,k)));
	  lot_tri_verts.push_back(
	    VBOPosNormalColor(pos+glm::vec3(1.0,0.0,0.0),y_bar,getLotColor(i,k)));
